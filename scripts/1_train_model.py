...
def train_model(
    ...
    data_module = GeneformerDataModule(dataset=dataset, batch_size=batch_size, bb_block_size=4, test_val_size=0.01, padding_token=padding_token, masking_token=masking_token)
