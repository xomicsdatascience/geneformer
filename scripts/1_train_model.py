...
def train_model(
    ...
    data_module = GeneformerDataModule(batch_size=batch_size, padding_token=padding_token, masking_token=masking_token, num_training_samples=num_training_samples)
