...
def run_training_job(parsed_args, random_state=0):
    ...
    data_module = GeneformerDataModule(dataset=dataset, batch_size=parsed_args.batch_size, num_batches_per_megabatch=10, test_val_size=0.01, padding_token=padding_token, masking_token=masking_token)
